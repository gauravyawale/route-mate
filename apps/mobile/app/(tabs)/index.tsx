...
export default function HomeScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      {/* Bold header — brand color, confident, fills the top */}
      <View
        style={{
      ...
      >
        {/* Floating stepper card — overlaps the header bottom edge */}
        <View
          style={{
...
function SavedLegBanner({ label, text }: { label: string; text: string }) {
